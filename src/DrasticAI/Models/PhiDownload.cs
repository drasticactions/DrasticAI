...
public class PhiDownload : INotifyPropertyChanged, IDisposable, IErrorHandlerService
{
    ...
    private PhiModelService service;

    public PhiDownload(PhiModel model, PhiModelService service, IAppDispatcher dispatcher)
    {
    ...
    public PhiModel Model { get; private set; }
